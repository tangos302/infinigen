...
def _scene_brief_block(map_size: str) -> str:
    ...
    return (
        ...
        "```python\n"
        "from infinigen.maquette.runtime.influence import Composition, Hero, Path, Water\n"
        "from infinigen.maquette.runtime.eroded_terrain import make_eroded_terrain\n"
        "\n"
        ...
        "        ],\n"
        "        paths=[Path(waypoints=PATH_PTS, width=2.4, depth=-0.05)],\n"
        ...
        "- **Path(waypoints, width=2.5, depth=0.0, blend=1.5)** — smooth "
